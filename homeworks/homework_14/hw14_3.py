...
возрастом 30, должностью "manager" и зарплатой 50000. Убедитесь, что атрибут last_name возвращается в верхнем регистре,
то есть "Ivanov".
...
class Person:
    ...
    def birthday(self):
        """
        >>> p1 = Employee("Ivanov", "Ivan", "Ivanovich", 30, "manager", 50000)
        >>> p1.birthday()
        >>> p1.get_age()
        31
       """
